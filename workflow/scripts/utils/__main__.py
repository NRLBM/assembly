...
def species_subparser(subparsers):
  ...
  input_args.add_argument("-i", "--input-dir", dest="inputdir", help="Location of assembly working directory and glob all summaries", metavar="ASSEMBLY DIR", default='~/assembly', type=str)
